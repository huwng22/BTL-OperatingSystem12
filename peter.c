...
int shmid1, shmid2, shmid3, shmid4; //khởi tạo 4 biến shmid
key_t k1 = 5491, k2 = 5812, k3 = 4327, k4 = 3213; //khởi tạo các giá trị key 1 đén 4
bool* SHM1;	//khởi tạo các biến SHM 
int* SHM2;
int* SHM3;
